...
<div class="content justify-content-center">
                    ...
                    <div class="form-row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="nombre y apellido" name="name" value= "{{ $user->name }}" required>
                                 @if($errors->has('name'))
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="email" placeholder="Correo electrónico" name="email" value= "{{ $user->email }}" required>
                                @if($errors->has('email'))
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="password_confirm" placeholder="Confirmar password" name="password_confirm"  required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <div class="form-check form-check-inline mt-sm-2" style="float:left">
                                                    <input class="form-check-input form-field-acceptconditions" type="checkbox" name="roles[]" id="{{$id}}" value="{{$id}}"   data-toggle="tooltip" data-placement="right" title=" {{$role}} " {{ $user->roles->contains($id) ? 'checked' : '' }} >
        ...
        <div class="text-center">
            <button type="submit" class="btn btn-primary btn-bg-inea">Actualizar</button>
        </div>
