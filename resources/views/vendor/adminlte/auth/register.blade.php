      ...
      {{-- Name field --}}
        ...
        <div class="input-group mb-3">
            <input type="text" name="apellidos" class="form-control {{ $errors->has('apellidos') ? 'is-invalid' : '' }}"
                   value="{{ old('apellidos') }}" placeholder="{{ __('adminlte::adminlte.last_name') }}" autofocus>
            <div class="input-group-append">
                <div class="input-group-text">
                    <span class="fas fa-user {{ config('adminlte.classes_auth_icon', '') }}"></span>
                </div>
...
<div class="form-group ">
        <x-adminlte-select2 name="tipo_documento" class="form-control">
        ...
        {{-- numero_identificacion field --}}
        <div class="input-group mb-3">
            <input type="text" name="numero_identificacion" class="form-control {{ $errors->has('numero_identificacion') ? 'is-invalid' : '' }}"
                   value="{{ old('numero_identificacion') }}" placeholder="{{ __('adminlte::adminlte.dni') }}" autofocus>
            <div class="input-group-append">
                <div class="input-group-text">
        ...
        <div class="input-group mb-3">
            <input type="text" name="telefono" class="form-control {{ $errors->has('telefono') ? 'is-invalid' : '' }}"
                   value="{{ old('telefono') }}" placeholder="{{ __('adminlte::adminlte.phone') }}" autofocus>
            <div class="input-group-append">
                <div class="input-group-text">
        ...
        <div class="input-group mb-3">
            <input type="text" name="direccion" class="form-control {{ $errors->has('direccion') ? 'is-invalid' : '' }}"
                   value="{{ old('direccion') }}" placeholder="{{ __('adminlte::adminlte.address') }}" autofocus>
            <div class="input-group-append">
                <div class="input-group-text">
